    ...
    <>
      <div className="mt-10 mb-16 md:mt-24 md:mb-20 xl:mb-[7.125rem]">
        ...
        <div className="mt-10 text-body-2 leading-body-2 flex flex-col gap-12 md:gap-10 md:mt-[7.25rem] xl:flex-row xl:items-start xl:justify-between">
          <aside className="py-6 border-y-[1px] border-y-line flex gap-3 items-start md:py-8 xl:max-w-[350px] xl:py-12 xl:sticky xl:top-0">
            <div className="flex-1 items-start md:gap-4">
              ...
              <p className="mt-6 text-basic md:hidden xl:block xl:mt-7">{currentProject.description}</p>
            ...
            <p className="flex-1 text-basic hidden md:block xl:hidden">{currentProject.description}</p>
          </aside>
          ...
          <div className="flex flex-col gap-10 xl:max-w-[635px]">
            <section>
              ...
              <p className="mt-7 text-basic">{currentProject.projectBackground}</p>
            </section>
            <section>
